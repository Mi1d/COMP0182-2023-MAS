...
# goal_pose = rospy.wait_for_message('/id325/aruco_single/pose', PoseStamped)
...
# init = rospy.Subscriber("/id321/aruco_single/pose", PoseStamped, goal_callback)
# init_msg = rospy.wait_for_message('/id321/aruco_single/pose', PoseStamped)
